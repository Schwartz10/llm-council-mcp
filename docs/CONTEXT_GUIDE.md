...
This guide explains how to provide effective context to the `consult_llm_council` MCP tool while staying within model limits. It includes a recommended brief schema, budget guidance, truncation examples, and scenario-specific examples.
...
```json
{
  ...
  "relevant_facts": [
    "Tool name is consult_llm_council",
...
- Repro: Send image/heic with data URL to consult_llm_council
